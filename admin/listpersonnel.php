...
require_once '../class/user_db.php';
    ...
    $paginationData = $dbuser->readuserrank("ผู้จัดการ", $page);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex text-center">
                                                    <!-- Edit -->
                                                    <a href="./editpersonnel.php?userid=<?php echo $row['u_id']; ?>" class="bi bi-pencil-square m-auto p-2 btn-warning rounded" role="button"> แก้ไข</a>
